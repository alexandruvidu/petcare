...
import { type ApiUserFileAddPostRequest, Configuration, UserFileApi } from "../client"
...
export const useGetUserFiles = (page: number, pageSize: number, search = "") => {
  ...
  return {
    ...useQuery({
      ...
      refetchInterval: Number.POSITIVE_INFINITY, // User information may not be frequently updated so refetching the data periodically is not necessary.
