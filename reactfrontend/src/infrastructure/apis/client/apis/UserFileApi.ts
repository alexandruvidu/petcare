...
import type { RequestResponse, UserFileDTOPagedResponseRequestResponse } from "../models/index"
import { RequestResponseFromJSON, UserFileDTOPagedResponseRequestResponseFromJSON } from "../models/index"
...
export class UserFileApi extends runtime.BaseAPI {
  /**
   */
  async apiUserFileAddPostRaw(
    requestParameters: ApiUserFileAddPostRequest,
  ...
  /**
   */
  async apiUserFileDownloadIdGetRaw(
    requestParameters: ApiUserFileDownloadIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async apiUserFileDownloadIdGet(
    requestParameters: ApiUserFileDownloadIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Blob> {
  ...
  /**
   */
  async apiUserFileGetPageGetRaw(
    requestParameters: ApiUserFileGetPageGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserFileDTOPagedResponseRequestResponse>> {
    const queryParameters: any = {}
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UserFileDTOPagedResponseRequestResponseFromJSON(jsonValue),
    )
  }

  /**
   */
  async apiUserFileGetPageGet(
    requestParameters: ApiUserFileGetPageGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserFileDTOPagedResponseRequestResponse> {
