...
export class UserApi extends runtime.BaseAPI {
  /**
   */
  async apiUserAddPostRaw(
    requestParameters: ApiUserAddPostRequest,
  ...
  /**
   */
  async apiUserDeleteIdDeleteRaw(
    requestParameters: ApiUserDeleteIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<RequestResponse>> {
  ...
  /**
   */
  async apiUserGetByIdIdGetRaw(
    requestParameters: ApiUserGetByIdIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserDTORequestResponse>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
  ...
  /**
   */
  async apiUserGetByIdIdGet(
    requestParameters: ApiUserGetByIdIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserDTORequestResponse> {
  ...
  /**
   */
  async apiUserGetPageGetRaw(
    requestParameters: ApiUserGetPageGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserDTOPagedResponseRequestResponse>> {
    const queryParameters: any = {}
  ...
  /**
   */
  async apiUserGetPageGet(
    requestParameters: ApiUserGetPageGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserDTOPagedResponseRequestResponse> {
  ...
  /**
   */
  async apiUserUpdatePutRaw(
    requestParameters: ApiUserUpdatePutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<RequestResponse>> {
    const queryParameters: any = {}
