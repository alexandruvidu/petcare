...
export const getBlob = (data: BlobPart, type?: string, onErrorMessage?: string): Blob | undefined => {
  try {
    ...
    const BlobBuilder =
      anyWindow.BlobBuilder || anyWindow.WebKitBlobBuilder || anyWindow.MozBlobBuilder || anyWindow.MSBlobBuilder
 ...
 */
export const openDocument = (data: BlobPart, contentType = "application/octet-stream", onErrorMessage?: string) => {
