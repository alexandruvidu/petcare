          ...
          <div className="grid grid-cols-2 gap-y-5 gap-x-5">
            ...
            <div className="col-span-2">
              <FormControl fullWidth error={!isUndefined(state.errors.role)}>
                ...
                <Select {...actions.register("role")} defaultValue={UserRoleEnum.User}>
                  <MenuItem value={UserRoleEnum.User}>
                    <FormattedMessage id="globals.roles.user" />
                  </MenuItem>
                  <MenuItem value={UserRoleEnum.PetSitter}>
                    <FormattedMessage id="globals.roles.petSitter" />
                  </MenuItem>
                </Select>
                <FormHelperText hidden={isUndefined(state.errors.role)}>{state.errors.role?.message}</FormHelperText>
              </FormControl>
            </div>
